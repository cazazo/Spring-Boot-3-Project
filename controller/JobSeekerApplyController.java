package com.caz.jobportal.controller;
...
import com.caz.jobportal.entity.RecruiterProfile;
import com.caz.jobportal.entity.Users;
import com.caz.jobportal.services.JobPostActivityService;
import com.caz.jobportal.services.JobSeekerApplyService;
import com.caz.jobportal.services.JobSeekerProfileService;
import com.caz.jobportal.services.JobSeekerSaveService;
import com.caz.jobportal.services.RecruiterProfileService;
import com.caz.jobportal.services.UsersService;
...
public class JobSeekerApplyController {
    ...
    public String display(@PathVariable("id") int id, Model model) {
        ...
        List<JobSeekerSave> jobSeekerSaveList = jobSeekerSaveService.getJobCadidates(jobDetails);
    ...
    public String apply(@PathVariable("id") int id, JobSeekerApply jobSeekerApply) {
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            System.out.println(seekerProfile);
            ...
            if (seekerProfile.isPresent() && jobPostActivity != null) {
                ...
                throw new RuntimeException("User not found, apply().");
            }
