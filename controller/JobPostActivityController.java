...
import com.caz.jobportal.entity.RecruiterJobsDto;
...
public class JobPostActivityController {
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if (authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))) {
                ...
                List<JobSeekerApply> jobSeekerApplyList = jobSeekerApplyService
                        .getCadidatesJobs((JobSeekerProfile) currentUserProfile);
    ...
    public String globalSearch(Model model,
        ...
        if (!dateSearchFlag && !remote && !type && !StringUtils.hasText(job) && !StringUtils.hasLength(location)) {
            jobPost = jobPostActivityService.getAll();
        } else {
            jobPost = jobPostActivityService.search(job, location, Arrays.asList(partTime, fullTime, freelance),
                    Arrays.asList(remoteOnly, officeOnly, partialRemote), searchDate);
